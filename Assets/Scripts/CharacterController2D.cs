...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump"))// if canDoubleJump and jump button is pressed, then allow player to double jump
		{
			DoJump ();
			// disable double jump after double jumping since you can only do it once again.
